...
#elif defined ARDUINO_MCU

#include "I2Cdev.h"

#define i2c_write(a, b, c, d) (!(I2Cdev::writeBytes(a, b, c, d)))
#define i2c_read(a, b, c, d) (-1 == (I2Cdev::readBytes(a, b, c, d)))
...
//#define i2c_write(a, b, c, d) (!(I2Cdev::writeBytes(a, b, c, d)))
//#define i2c_read(a, b, c, d) (-1 == (I2Cdev::readBytes(a, b, c, d)))
//#define i2c_write(a, b, c, d) i2c_write_call(&I2Cdev ,a, b, c, d)
//#define i2c_read(a, b, c, d) i2c_read_call(&I2Cdev, a, b, c, d)
...
#define LOAD_CHUNK  (16)
    ...
    unsigned char firmware_tmp[LOAD_CHUNK];
    ...
    for (ii = 0; ii < length; ii += this_write) {
        ...
        for (i = 0; i < this_write; i++) 
            firmware_tmp[i] = pgm_read_byte_near(firmware + ii + i);
        if (mpu_write_mem(ii, this_write, firmware_tmp))
            return -1;
        if (mpu_read_mem(ii, this_write, cur))
            return -1;
        if (memcmp(firmware_tmp, cur, this_write))
            return -2;
    }
